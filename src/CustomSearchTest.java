/**
 * Unit tests for the CustomSearch class.
 * <p>
 * This test verifies that the search and task update
 * functionality in the CustomSearch and Task classes works correctly.
 * It includes tests for searching tasks by ID, searching by keyword,
 * and updating a task's title.
 * </p>
 *
...
/**
 * Tests searching for a task by its ID
 * Ensures that only correct task is removed
 */
...
public class CustomSearchTest {
    ...
    /**
     * Tests searching for tasks using keyword in the title
     * Ensures the correct task is matched and returned.
     */
    ...
    /**
     * Tests that updating a task title correctly modifies the value.
     */
    ...
    public void testUpdateTitle() { //Test to see if updating the title actually changes
        ...
        task.setTitle("New Title"); //updates task
